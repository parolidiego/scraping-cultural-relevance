...
data <- main_link |> 
  request() |>
  req_url_query(`api-key` = Sys.getenv("API_KEY_NYT"), begin_date = 20070114, end_date = 20070115) |> 
  req_perform() |> 
...
dates <- dates_creator("2005-06-01", "2006-07-31")
...
if (!file.exists("data/nyt_database.csv")) {
    ...
    write_csv(news, "data/nyt_database.csv", append = TRUE)
  }
...
```{r}
data <- read_csv("data/nyt_database.csv")
```
